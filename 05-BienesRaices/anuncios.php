...
?>
        ...
        <div class="contenedor-anuncios">
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img width="200" height="300" loading="lazy" ,src="build/img/anuncio4.jpg" alt="Cuarto Anuncio">
                </picture>

                <div class="contenido-anuncio">
                    <h3>Casa para Familias</h3>
                    <p>La mejor casa para comenzar una familia con el amor de tu vida</p>
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img width="200" height="300" loading="lazy" ,src="build/img/anuncio5.jpg" alt="Quinto Anuncio">
                </picture>

                <div class="contenido-anuncio">
                    <h3>Casa con Garaje</h3>
                    <p>Amplia casa con muchos puestos de estacionamiento</p>
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img width="200" height="300" loading="lazy" ,src="build/img/anuncio6.jpg" alt="Sexto Anuncio">
                </picture>

                <div class="contenido-anuncio">
                    <h3>Casa Fuera de la Ciudad</h3>
                    <p>Casa ideal para desconectarse y relajarse</p>
    ...
    <footer class="footer seccion">
        ...
        <p class="copyright">Todos los Derechos Reservados. <span class="annoGenerado" id="annoGenerado"></span> &copy;
        </p>
    </footer>

    ...
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">
                PankraCamp es una conferencia para desarrolladores de todos los niveles. Se lleva a cabo de forma presencial y en línea.
            </p>
        </div>
        ...
        <nav class="menu-redes">
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://linkedin.com">

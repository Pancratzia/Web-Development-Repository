<header class="header">
    <div class="header__contenedor">
        ...
        <div class="header__contenido">
            <a href="/">
                <h1 class="header__logo">&#60;PankraCamp/></h1>
            </a>
...
<div class="barra">
    <div class="barra__contenido">
        <a href="/">
            <h2 class="barra__logo">&#60;PankraCamp/></h2>
        </a>

        <nav class="navegacion">
            <a href="/pankracamp" class="navegacion__enlace <?php echo pagina_actual('/pankracamp') ? 'navegacion__enlace--actual' : ''; ?>">Evento</a>
